 ...
 * @var   bool     $hasSearch       Does the field have a search IFRAME below it?
 */
...
$class = $class ?? '';
$class .= $hasSearch ? ((empty($class) ? '' : ' ') . 'atsInstantSearch') : '';
...
<?php if ($hasSearch): ?>
<div id="<?= $id ?>_searchresults" class="ats-post-searchresults ratio ratio-4x3 border rounded-1 my-3 d-none"></div>
<?php endif; ?>
