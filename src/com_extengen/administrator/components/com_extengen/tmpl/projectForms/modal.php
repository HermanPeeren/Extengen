...
<div class="container-popup">
	...
	<form action="<?php echo Route::_('index.php?option=com_extengen&view=projects&layout=modal&tmpl=component&function=' . $function . '&' . Session::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
