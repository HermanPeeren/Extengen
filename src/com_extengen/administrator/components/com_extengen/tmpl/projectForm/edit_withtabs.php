...
<form action="<?php echo Route::_('index.php?option=com_extengen&view=projectform&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="projectform-form" class="form-validate">
	...
	<div>
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'concepts', Text::_('COM_EXTENGEN_HEADING_CONCEPTS')); ?>
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'datatypes', Text::_('COM_EXTENGEN_HEADING_INTERFACES')); ?>
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'pages', Text::_('COM_EXTENGEN_HEADING_DATATYPES')); ?>
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'pages', Text::_('COM_EXTENGEN_HEADING_ANNOTATIONS')); ?>
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
